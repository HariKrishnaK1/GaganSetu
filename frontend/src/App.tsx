  ...
  return <div className={`app-shell ${sidebarOpen ? '' : 'sidebar-closed'}`}>
    <aside className={`sidebar ${sidebarOpen ? '' : 'collapsed'}`} aria-expanded={sidebarOpen}>
      <div className="sidebar-inner">
        ...
        {/* GROUP 1: STANDARD SIDEBAR SECTIONS */}
        <details open className="sidebar-mobile-group">
          <summary className="sidebar-group-summary mobile-only">
            <span className="group-title"><SlidersHorizontal size={14}/> Mission Setup & Controls</span>
        ...
        {/* GROUP 2: HEADER QUICK CONTROLS & OVERLAYS (Moved from Header for Mobile Screens) */}
        <div className="sidebar-mobile-controls">
          <details open className="sidebar-mobile-group">
            <summary className="sidebar-group-summary mobile-only">
              <span className="group-title"><Activity size={14}/> Header Controls & Overlays</span>
              <ChevronRight size={14} className="group-chevron"/>
            </summary>
            <div className="sidebar-group-content">
              <div className="sidebar-box">
